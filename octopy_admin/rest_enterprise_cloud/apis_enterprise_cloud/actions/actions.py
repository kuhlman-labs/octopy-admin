...
class Actions:
    ...
    def get_the_opt_out_flag_of_an_oidc_subject_claim_customization_for_a_repository(
        ...
        Docs:
        https://docs.github.com/enterprise-cloud@latest//rest/actions/oidc#get-the-opt-out-flag-of-an-oidc-subject-claim-customization-for-a-repository
        """
        url = self._base_url + f"/repos/{owner}/{repo}/actions/oidc/customization/sub"
        response = self._execute("get", url, params=params, payload=payload)
        return response

    def set_the_opt_in_flag_of_an_oidc_subject_claim_customization_for_a_repository(
        self, owner, repo, params=None, payload=None
    ):
        """
        Summary:
        ...
        Docs:
        https://docs.github.com/enterprise-cloud@latest//rest/actions/oidc#set-the-opt-out-flag-of-an-oidc-subject-claim-customization-for-a-repository
        """
        url = self._base_url + f"/repos/{owner}/{repo}/actions/oidc/customization/sub"
        response = self._execute("put", url, params=params, payload=payload)
        return response
