...
class OauthAuthorizations:
    ...
    def list_your_grants(self, **payload):
        """
        List your grants
    ...
    def get_a_single_grant(self, grant_id, **payload):
        """
        Get a single grant
    ...
    def delete_a_grant(self, grant_id, **payload):
        """
        Delete a grant
    ...
    def list_your_authorizations(self, **payload):
        """
    ...
    def create_a_new_authorization(self, **payload):
        """
    ...
    def get_a_single_authorization(self, authorization_id, **payload):
        """
    ...
    def update_an_existing_authorization(self, authorization_id, **payload):
        """
    ...
    def delete_an_authorization(self, authorization_id, **payload):
        """
